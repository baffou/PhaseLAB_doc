.. dropdown:: **D2Wnorm** |subTitle| Return the second derivative (Laplacian) of the OPD image of the *ImageQLSI* object. |/subTitle|
    ...
    Returns the second derivative (Laplacian) of the OPD image of the |ImageQLSI| object, computed from the two gradient images :matlab:`DWx` and :matlab:`DWy`. 
