.. dropdown:: **alpha** |subTitle| Computes and returns the alpha value of the QLSI camera system. |/subTitle|
    ...
    where :math:`\Gamma`  is the pitch of the grating, :math:`p` is the dexel size of the camera, :math:`Z` the zoom of the |RL|, and :math:`d` is the camera-grating distance.
